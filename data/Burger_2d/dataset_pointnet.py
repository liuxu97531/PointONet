...
def generate_one_test_data(key, num_of_sensors, num_query_points, num_sine_terms, sine_amplitude, Nx, Nt, T_lim, period,
  ...
  x_obs = x_obs
  u_r = u_r
  u_test = u  # copy u for Nx * Nt times
...
def generate_data_pointnet(test_key, N, P, m):
